#ifndef _GxEPD2_750c_ZJY_H_
#define _GxEPD2_750c_ZJY_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_750c_ZJY : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 64; // 800;
    static const uint16_t WIDTH_VISIBLE = WIDTH;
    static const uint16_t HEIGHT = 64; // 480;
    ...
    static const bool useFastPartialUpdateFromOTP = false; // set this false for earlier batches, such as the panel I have (1580258us)
    static const uint16_t power_on_time = 140; // ms, e.g. 129018us
    static const uint16_t power_off_time = 42; // ms, e.g. 28000us
    static const uint16_t full_refresh_time = 30000; // ms, e.g. 1171000us
    static const uint16_t partial_refresh_time = 27000; // ms, e.g. 25691000us
    // constructor
    GxEPD2_750c_ZJY(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
